const en = {
  ...
  addtaxforthisproduct: "Add tax for this product",
  discountprice: "Discount Price",
  priceatdiscount: "Price at Discount",
  differentoptions: "Different Options",
  thisproducthasmultipleoptions: "This product has multiple options",
  option: "Option",
  size: "Size",
  value: "Value",
  addmore: "Add More",
  ...
  thisisdigitalitem: "This is digital item",
  women: "Women",
  men: "Men",
  tshirt: "T-Shirt",
  hoodie: "Hoodie",
  ...
  mostimportantinformationaboutthecustomer:
  ...
  addnotesaboutcustomer: "Add notes about customer",
  notes: "Notes",
  // addCustomer
  // editcustome
  order: "order",
